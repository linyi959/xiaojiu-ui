export default {
  ...
  chat: {
    ...
    autoPlaySpeech: 'Auto-play replies',
    playSpeech: 'Play speech',
    ...
    sessions: 'Sessions',
    webUiSessions: 'Session Links',
    sessionScopeHint: 'Only command-core web sessions are shown here. Open history for the full archive.',
